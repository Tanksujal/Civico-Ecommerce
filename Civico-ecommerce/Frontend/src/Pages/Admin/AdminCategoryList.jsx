    ...
    return (
        <section className="flex">
            ...
            <div className="col-10">
                <h1 className="fs-25 p-color leading-[30px]  ms-3 fw-600 mt-2">Category List</h1>
                                    ...
                                    {filteredCategories.length > 0 ? (
                                        filteredCategories.map(category => (
                                            <tr key={category._id}>
                                                ...
                                                <td>
                                                    <Link to={`/categories/edit/${category._id}`} state={{ category }} className="mt-2 btn-main-add-edit justify-center items-center flex text-white leading-[1.2] tracking-[0.03rem] fw-400 fs-14 py-2 px-1 transition-all duration-500 ease-in-out rounded-lg banner-font fw-600">
                                                        Edit
                                                    </Link>
                                                </td>
                                                <td>
                                                    <Link className="mt-2 btn-main-add-delete justify-center items-center flex text-white leading-[1.2] tracking-[0.03rem] fw-400 fs-14 py-2 px-1 transition-all duration-500 ease-in-out rounded-lg banner-font fw-600" onClick={() => dispatch(deletecategory(category._id)).then(()=>{
                                                      dispatch(getAllcategory())
                                                    })}>
                                                        Delete
                                                    </Link>
